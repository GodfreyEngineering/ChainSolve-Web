...
const tierFeatures = {
  free: [
    ...
    { label: 'upgrade.featListBlocks', included: false },
    { label: 'upgrade.featGraphTableOutputs', included: false },
    { label: 'upgrade.featImportFiles', included: false },
  ...
  pro: [
    ...
    { label: 'upgrade.featListBlocks', included: true },
    { label: 'upgrade.featGraphTableOutputs', included: true },
    { label: 'upgrade.featImportFiles', included: true },
