...
reg({
  type: 'veh.suspension.halfCar',
  label: 'Half Car (4-DOF)',
  category: 'vehicleSim',
  nodeKind: 'csOperation',
  inputs: [
    { id: 'road_front', label: 'Road front (m)' },
    { id: 'road_rear', label: 'Road rear (m)' },
  ],
  defaultData: {
...
reg({
  type: 'veh.suspension.fullCar',
  label: 'Full Vehicle (7-DOF)',
  category: 'vehicleSim',
  nodeKind: 'csOperation',
  inputs: [
    { id: 'road_fl', label: 'Road FL (m)' },
    { id: 'road_fr', label: 'Road FR (m)' },
    { id: 'road_rl', label: 'Road RL (m)' },
    { id: 'road_rr', label: 'Road RR (m)' },
  ],
  defaultData: {
...
reg({
  type: 'veh.event.sineSweep',
  label: 'Sine Steer Sweep',
  category: 'vehicleSim',
  nodeKind: 'csOperation',
  inputs: [],
  defaultData: {
...
reg({
  type: 'veh.event.laneChange',
  label: 'ISO Lane Change',
  category: 'vehicleSim',
  nodeKind: 'csOperation',
  inputs: [],
  defaultData: {
...
reg({
  ...
  tags: ['vehicle', 'event', 'steady-state'],
  description: 'Constant radius steady-state manoeuvre. Fixed steer angle and throttle throughout.',
})
