...
export function buildVehicleSuspension(canvasId: string, projectId: string): CanvasJSON {
  const nodes = [
    ...
    // ── Inputs: sprung side ──────────────────────────────────────────────
    { id: 'vs-ks', type: 'csSource', position: { x: 0, y: 40 }, data: { blockType: 'number', label: 'Spring stiffness ks (N/m)', value: 25000 } },
    { id: 'vs-ms', type: 'csSource', position: { x: 0, y: 160 }, data: { blockType: 'number', label: 'Sprung mass ms (kg)', value: 350 } },
    { id: 'vs-cs', type: 'csSource', position: { x: 0, y: 280 }, data: { blockType: 'number', label: 'Damper cs (N·s/m)', value: 3500 } },

    // ── Inputs: unsprung side ────────────────────────────────────────────
    { id: 'vs-ku', type: 'csSource', position: { x: 0, y: 420 }, data: { blockType: 'number', label: 'Tyre stiffness ku (N/m)', value: 200000 } },
    { id: 'vs-mu', type: 'csSource', position: { x: 0, y: 540 }, data: { blockType: 'number', label: 'Unsprung mass mu (kg)', value: 45 } },

    // ── Operations: sprung frequency ──────────────────────────────────────
    { id: 'vs-wn-s', type: 'csOperation', position: { x: 300, y: 80 }, data: { blockType: 'ctrl.natural_freq', label: 'ωn_s = √(ks/ms)' } },
    { id: 'vs-fn-s', type: 'csOperation', position: { x: 300, y: 180 }, data: { blockType: 'ctrl.natural_freq_hz', label: 'fn_s (Hz)' } },

    // ── Operations: damping ──────────────────────────────────────────────
    { id: 'vs-zeta', type: 'csOperation', position: { x: 300, y: 300 }, data: { blockType: 'ctrl.damping_ratio', label: 'ζ = cs/(2√(ks·ms))' } },
    { id: 'vs-os', type: 'csOperation', position: { x: 300, y: 400 }, data: { blockType: 'ctrl.overshoot_2nd', label: '% Overshoot' } },

    // ── Operations: unsprung frequency ──────────────────────────────────
    { id: 'vs-wn-u', type: 'csOperation', position: { x: 300, y: 520 }, data: { blockType: 'ctrl.natural_freq', label: 'ωn_u = √(ku/mu)' } },
    { id: 'vs-fn-u', type: 'csOperation', position: { x: 300, y: 620 }, data: { blockType: 'ctrl.natural_freq_hz', label: 'fn_u (Hz)' } },

    // ── Displays ─────────────────────────────────────────────────────────
    { id: 'vs-disp-fn-s', type: 'csDisplay', position: { x: 560, y: 180 }, data: { blockType: 'display', label: 'Sprung freq fn_s (Hz)' } },
    { id: 'vs-disp-zeta', type: 'csDisplay', position: { x: 560, y: 300 }, data: { blockType: 'display', label: 'Damping ratio ζ' } },
    { id: 'vs-disp-os', type: 'csDisplay', position: { x: 560, y: 400 }, data: { blockType: 'display', label: '% Overshoot' } },
    { id: 'vs-disp-fn-u', type: 'csDisplay', position: { x: 560, y: 620 }, data: { blockType: 'display', label: 'Unsprung freq fn_u (Hz)' } },
  ...
  const edges = [
    ...
    { id: 'vs-e5', source: 'vs-fn-s', sourceHandle: 'out', target: 'vs-disp-fn-s', targetHandle: 'value' },
    // damping ratio
    ...
    { id: 'vs-e9', source: 'vs-zeta', sourceHandle: 'out', target: 'vs-disp-zeta', targetHandle: 'value' },
    // overshoot
    { id: 'vs-e10', source: 'vs-zeta', sourceHandle: 'out', target: 'vs-os', targetHandle: 'zeta' },
    { id: 'vs-e11', source: 'vs-os', sourceHandle: 'out', target: 'vs-disp-os', targetHandle: 'value' },
    ...
    { id: 'vs-e16', source: 'vs-fn-u', sourceHandle: 'out', target: 'vs-disp-fn-u', targetHandle: 'value' },
  ]
