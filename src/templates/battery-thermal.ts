...
export function buildBatteryThermal(canvasId: string, projectId: string): CanvasJSON {
  const nodes = [
    ...
    // ── Electrical inputs ─────────────────────────────────────────────────
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 40 },
      data: { blockType: 'number', label: 'Discharge current I (A)', value: 20 },
    },
    {
      id: 'bt-Rint',
      type: 'csSource',
      position: { x: 0, y: 160 },
      data: { blockType: 'number', label: 'Internal resistance R_int (Ω)', value: 0.005 },
    },
    ...
    // ── Thermal inputs ────────────────────────────────────────────────────
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 320 },
      data: { blockType: 'number', label: 'Conv. coeff h (W/m²K)', value: 10 },
    },
    {
      id: 'bt-A',
      type: 'csSource',
      position: { x: 0, y: 440 },
      data: { blockType: 'number', label: 'Surface area A (m²)', value: 0.02 },
    },
    {
      id: 'bt-Tamb',
      type: 'csSource',
      position: { x: 0, y: 560 },
      data: { blockType: 'number', label: 'Ambient temp T_amb (°C)', value: 25 },
    },
    {
      id: 'bt-m',
      type: 'csSource',
      position: { x: 0, y: 680 },
      data: { blockType: 'number', label: 'Cell mass m (kg)', value: 0.045 },
    },
    {
      id: 'bt-Cp',
      type: 'csSource',
      position: { x: 0, y: 800 },
      data: { blockType: 'number', label: 'Specific heat Cp (J/kg·K)', value: 900 },
    },
    {
      id: 'bt-t',
      type: 'csSource',
      position: { x: 0, y: 920 },
      data: { blockType: 'number', label: 'Discharge time t (s)', value: 600 },
    },
    ...
    // ── Displays ──────────────────────────────────────────────────────────
    {
      ...
      data: { blockType: 'display', label: 'Heat gen Q_gen (W)' },
    },
    {
      id: 'bt-disp-Qloss',
      type: 'csDisplay',
      position: { x: 580, y: 780 },
      data: { blockType: 'display', label: 'Cooling Q_loss (W)' },
    },
    {
      id: 'bt-disp-Qnet',
      type: 'csDisplay',
      position: { x: 580, y: 900 },
      data: { blockType: 'display', label: 'Net heat rate Q_net (W)' },
    },
    {
      id: 'bt-disp-dT',
      type: 'csDisplay',
      position: { x: 580, y: 1120 },
      data: { blockType: 'display', label: 'Temperature rise ΔT (°C)' },
    },
    {
      id: 'bt-disp-Tcell',
      type: 'csDisplay',
      position: { x: 580, y: 1240 },
      data: { blockType: 'display', label: 'Cell temp T_cell (°C)' },
    },
