...
export function buildNeuralNetworkTraining(canvasId: string, projectId: string): CanvasJSON {
  const nodes = [
    ...
    // ── Hyperparameter inputs ────────────────────────────────────────────
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 40 },
      data: { blockType: 'number', label: 'Learning rate α', value: 0.001 },
    },
    {
      id: 'nn-epochs',
      type: 'csSource',
      position: { x: 0, y: 160 },
      data: { blockType: 'number', label: 'Epochs', value: 50 },
    },
    {
      id: 'nn-batch',
      type: 'csSource',
      position: { x: 0, y: 280 },
      data: { blockType: 'number', label: 'Batch size', value: 32 },
    },
    {
      id: 'nn-dropout',
      type: 'csSource',
      position: { x: 0, y: 400 },
      data: { blockType: 'number', label: 'Dropout rate p', value: 0.2 },
    },
    {
      id: 'nn-hidden',
      type: 'csSource',
      position: { x: 0, y: 520 },
      data: { blockType: 'number', label: 'Hidden units h', value: 64 },
    },
    {
      id: 'nn-inputs',
      type: 'csSource',
      position: { x: 0, y: 640 },
      data: { blockType: 'number', label: 'Input features n_in', value: 16 },
    },
    {
      id: 'nn-outputs',
      type: 'csSource',
      position: { x: 0, y: 760 },
      data: { blockType: 'number', label: 'Output classes n_out', value: 3 },
    },
    ...
    // ── Loss inputs (predicted logit & true label) ────────────────────────
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 900 },
      data: { blockType: 'number', label: 'Predicted probability ŷ', value: 0.72 },
    },
    {
      id: 'nn-true',
      type: 'csSource',
      position: { x: 0, y: 1020 },
      data: { blockType: 'number', label: 'True label y (0 or 1)', value: 1 },
    },
    ...
    // ── Displays ──────────────────────────────────────────────────────────
    {
      ...
      data: { blockType: 'display', label: 'Layer 1 params' },
    },
    {
      id: 'nn-disp-p2',
      type: 'csDisplay',
      position: { x: 560, y: 900 },
      data: { blockType: 'display', label: 'Layer 2 params' },
    },
    {
      id: 'nn-disp-total',
      type: 'csDisplay',
      position: { x: 560, y: 1000 },
      data: { blockType: 'display', label: 'Total parameters' },
    },
    {
      id: 'nn-disp-loss',
      type: 'csDisplay',
      position: { x: 560, y: 1320 },
      data: { blockType: 'display', label: 'Cross-entropy loss H' },
    },
