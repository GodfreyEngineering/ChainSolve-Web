...
export function buildFullVehicleModel(canvasId: string, projectId: string): CanvasJSON {
  const nodes = [
    ...
    // Inputs
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 610 },
      data: { blockType: 'number', label: 'Engine torque (Nm)', value: 350 },
    },
    {
      id: 'fv-eng-rpm',
      type: 'csSource',
      position: { x: 0, y: 680 },
      data: { blockType: 'number', label: 'Engine RPM', value: 3500 },
    },
    {
      id: 'fv-gear-ratio',
      type: 'csSource',
      position: { x: 0, y: 750 },
      data: { blockType: 'number', label: 'Gear ratio', value: 4.2 },
    },
    {
      id: 'fv-tire-r',
      type: 'csSource',
      position: { x: 0, y: 820 },
      data: { blockType: 'number', label: 'Tyre radius (m)', value: 0.32 },
    },
    {
      id: 'fv-drv-eta',
      type: 'csSource',
      position: { x: 0, y: 890 },
      data: { blockType: 'number', label: 'Drivetrain η', value: 0.88 },
    },
    ...
    // Displays
    {
      id: 'fv-disp-torque-out',
      type: 'csDisplay',
      position: { x: 560, y: 640 },
      data: { blockType: 'display', label: 'Wheel torque (Nm)' },
    },
    {
      id: 'fv-disp-p-out',
      type: 'csDisplay',
      position: { x: 560, y: 770 },
      data: { blockType: 'display', label: 'Wheel power (W)' },
    },
    {
      id: 'fv-disp-veh-spd',
      type: 'csDisplay',
      position: { x: 560, y: 870 },
      data: { blockType: 'display', label: 'Vehicle speed (m/s)' },
    },
    ...
    // Shared aero inputs
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 1070 },
      data: { blockType: 'number', label: 'Air density ρ (kg/m³)', value: 1.225 },
    },
    {
      id: 'fv-aero-v',
      type: 'csSource',
      position: { x: 0, y: 1140 },
      data: { blockType: 'number', label: 'Speed (m/s)', value: 50 },
    },
    {
      id: 'fv-aero-A',
      type: 'csSource',
      position: { x: 0, y: 1210 },
      data: { blockType: 'number', label: 'Front area A (m²)', value: 2.2 },
    },
    {
      id: 'fv-aero-Cd',
      type: 'csSource',
      position: { x: 0, y: 1280 },
      data: { blockType: 'number', label: 'Drag coeff Cd', value: 0.3 },
    },
    {
      id: 'fv-aero-Cl-f',
      type: 'csSource',
      position: { x: 0, y: 1350 },
      data: { blockType: 'number', label: 'Lift coeff front Cl_f', value: 0.25 },
    },
    {
      id: 'fv-aero-Cl-r',
      type: 'csSource',
      position: { x: 0, y: 1420 },
      data: { blockType: 'number', label: 'Lift coeff rear Cl_r', value: 0.45 },
    },
    ...
    // Displays
    {
      ...
      data: { blockType: 'display', label: 'Drag force (N)' },
    },
    {
      id: 'fv-disp-df-f',
      type: 'csDisplay',
      position: { x: 560, y: 1200 },
      data: { blockType: 'display', label: 'Front downforce (N)' },
    },
    {
      id: 'fv-disp-df-r',
      type: 'csDisplay',
      position: { x: 560, y: 1420 },
      data: { blockType: 'display', label: 'Rear downforce (N)' },
    },
    {
      id: 'fv-disp-balance',
      type: 'csDisplay',
      position: { x: 980, y: 1310 },
      data: { blockType: 'display', label: 'Aero balance (%)' },
    },
    ...
    // Pacejka inputs (typical medium-compound road tyre)
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 1620 },
      data: { blockType: 'number', label: 'Vertical load Fz (N)', value: 3000 },
    },
    {
      id: 'fv-tire-B',
      type: 'csSource',
      position: { x: 0, y: 1690 },
      data: { blockType: 'number', label: 'Pacejka B', value: 10 },
    },
    {
      id: 'fv-tire-C',
      type: 'csSource',
      position: { x: 0, y: 1760 },
      data: { blockType: 'number', label: 'Pacejka C', value: 1.9 },
    },
    {
      id: 'fv-tire-D',
      type: 'csSource',
      position: { x: 0, y: 1830 },
      data: { blockType: 'number', label: 'Pacejka D (peak Fy, N)', value: 3300 },
    },
    {
      id: 'fv-tire-E',
      type: 'csSource',
      position: { x: 0, y: 1900 },
      data: { blockType: 'number', label: 'Pacejka E', value: -0.5 },
    },
    {
      id: 'fv-tire-sa',
      type: 'csSource',
      position: { x: 0, y: 1970 },
      data: { blockType: 'number', label: 'Slip angle (rad)', value: 0.05 },
    },
...

    {
      ...
      data: { blockType: 'display', label: 'Lateral force Fy (N)' },
    },
    {
      id: 'fv-disp-sweep',
      type: 'csDisplay',
      position: { x: 560, y: 1850 },
      data: { blockType: 'display', label: 'Fy Sweep table' },
    },
...

    {
      ...
      type: 'csSource',
      position: { x: 0, y: 2120 },
      data: { blockType: 'number', label: 'Vehicle mass (kg)', value: 1200 },
    },
    {
      id: 'fv-brk-v1',
      type: 'csSource',
      position: { x: 0, y: 2190 },
      data: { blockType: 'number', label: 'Initial speed v₁ (m/s)', value: 38.9 },
    },
    {
      id: 'fv-brk-v2',
      type: 'csSource',
      position: { x: 0, y: 2260 },
      data: { blockType: 'number', label: 'Final speed v₂ (m/s)', value: 0 },
    },
    {
      id: 'fv-brk-dt',
      type: 'csSource',
      position: { x: 0, y: 2330 },
      data: { blockType: 'number', label: 'Braking time Δt (s)', value: 3.5 },
    },
...

    {
      id: 'fv-disp-brk-e',
      type: 'csDisplay',
      position: { x: 560, y: 2160 },
      data: { blockType: 'display', label: 'Brake energy (J)' },
    },
    {
      id: 'fv-disp-brk-p',
      type: 'csDisplay',
      position: { x: 560, y: 2280 },
      data: { blockType: 'display', label: 'Average brake power (W)' },
    },
...

    {
      ...
      data: { blockType: 'display', label: 'K&C Results' },
    },
  ]
  ...
  const edges = [
    ...
    },
    {
      id: 'fv-e-gear-out',
      source: 'fv-gear',
      sourceHandle: 'torque_out',
      target: 'fv-disp-torque-out',
      targetHandle: 'value',
      animated: true,
    },
    ...
    {
      id: 'fv-e-ts-out',
      source: 'fv-tire-sweep',
      sourceHandle: 'out',
      target: 'fv-disp-sweep',
      targetHandle: 'value',
      animated: true,
    },
    ...
    {
      id: 'fv-e-be-out',
      source: 'fv-brk-energy',
      sourceHandle: 'out',
      target: 'fv-disp-brk-e',
      targetHandle: 'value',
      animated: true,
    },
    {
