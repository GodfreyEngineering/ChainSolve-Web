...
export function buildPidController(canvasId: string, projectId: string): CanvasJSON {
  const nodes = [
    // ── Inputs ──────────────────────────────────────────────────────────
    {
      ...
      type: 'csSource',
      position: { x: 0, y: 0 },
      data: { blockType: 'number', label: 'Kp (proportional gain)', value: 1 },
    },
    {
      id: 'pid-ki',
      type: 'csSource',
      position: { x: 0, y: 100 },
      data: { blockType: 'number', label: 'Ki (integral gain)', value: 0.1 },
    },
    {
      id: 'pid-kd',
      type: 'csSource',
      position: { x: 0, y: 200 },
      data: { blockType: 'number', label: 'Kd (derivative gain)', value: 0.05 },
    },
    {
      id: 'pid-error',
      type: 'csSource',
      position: { x: 0, y: 320 },
      data: { blockType: 'number', label: 'Error e(t)', value: 1 },
    },
    {
      id: 'pid-integral',
      type: 'csSource',
      position: { x: 0, y: 420 },
      data: { blockType: 'number', label: 'Integral ∫e dt', value: 0 },
    },
    {
      id: 'pid-dt',
      type: 'csSource',
      position: { x: 0, y: 520 },
      data: { blockType: 'number', label: 'Time step Δt (s)', value: 0.01 },
    },
    ...
    // ── PID block ────────────────────────────────────────────────────────
    {
      ...
      data: { blockType: 'ctrl.pid_output', label: 'PID Output u(t)' },
    },
    ...
    // ── Display ──────────────────────────────────────────────────────────
    {
      ...
      data: { blockType: 'display', label: 'Control output u(t)' },
    },
