...
type Action = 'search' | 'get_user' | 'override_plan' | 'reset_password' | 'toggle_disabled'
...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  function logAudit(eventType: string, objectId: string, metadata: Record<string, unknown>) {
    adminClient
      .from('audit_log')
      .insert({
        user_id: caller!.id,
